...
class GalleryController extends Controller
{
    ...
    public function __construct(Gallery $model, FileService $fileService, CrudService $crudService)
    {
        $this->model = $model;
    ...
    public function post(Request $request, $id = null)
    {
        ...
        return redirect()->route('admin.gallery.index')->with('success', 'Успешно сохранено');
    }
