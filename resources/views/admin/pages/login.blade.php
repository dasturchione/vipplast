...
<head>
    ...
    <title>Kirish | Vipplast - Admin panel</title>
...
<body>
    ...
    <div class="relative p-6 bg-white z-1 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen sm:p-0 lg:flex-row">
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    <div>
                        ...
                        <div>
                            @if ($errors->has('email'))
                                <div class="mb-4 border border-red-500 bg-red-100 p-3 rounded">
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-600 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    <!-- ===== Common Grid Shape Start ===== -->
                    @include('admin.partials.common-grid-shape')
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="index.html" class="block mb-4">
                            <img src="{{ asset('storage/company/logo2.svg') }}" alt="Logo" />
                        </a>
                        <p class="text-center text-gray-400">
                            Yetakchi plastik mahsulot yetkazib beruvchi kompaniya.
                        </p>
                    </div>
                </div>
            </div>
