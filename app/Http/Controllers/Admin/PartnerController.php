...
class PartnerController extends Controller
{
    ...
    public function __construct(Partner $model, FileService $fileService, CrudService $crudService)
    {
        $this->model = $model;
    ...
    public function post(Request $request, $id = null)
    {
        ...
        return redirect()->route('admin.partner.index')->with('success', 'Успешно сохранено');
    }
