...
<header x-data="{ menuToggle: false }"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.html" class="lg:hidden h-10 overflow-hidden flex items-center">
                <img class="dark:hidden w-auto h-20 lg:h-30" src="{{ asset('storage/company/logo2.svg') }}" alt="Logo" />
                <img class="hidden dark:block w-auto h-20 lg:h-30" src="{{ asset('storage/company/logo2.svg') }}" alt="Logo" />
            </a>
                            ...
                            <li>
                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                    ...
                                    <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                        <img src="{{ asset('storage/images/user/user_image.jpg') }}" alt="User"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ asset('storage/images/user/user_image.png') }}" alt="User" />
                    </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                        ...
                        <li>
                            <a href="https://t.me/dasturchi_one" target="_blank"
                                class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                <svg class="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button @click="window.location.href='{{ route('admin.logout') }}'"
